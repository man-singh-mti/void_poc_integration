...
#define ICM20948_REG_LP_CONFIG_DEFAULT \
	(ICM20948_REG_LP_CONFIG_I2C_MST_CYCLE_MSK)
#define ICM20948_REG_LP_CONFIG_ACCEL_CYCLE    \
	(ICM20948_REG_LP_CONFIG_I2C_MST_CYCLE_MSK \
	| ICM20948_REG_LP_CONFIG_ACCEL_CYCLE_MSK)
...
#define ICM20948_REG_PWR_MGMT_1_DEFAULT     \
	((ICM20948_REG_PWR_MGMT_1_TEMP_DIS_MSK) \
	| (ICM20948_REG_PWR_MGMT_1_CLKSEL_AUTO  \
	<< ICM20948_REG_PWR_MGMT_1_CLKSEL_POS))
#define ICM20948_REG_PWR_MGMT_1_LOW_POWER    \
	(ICM20948_REG_PWR_MGMT_1_LP_EN_MSK       \
	| (ICM20948_REG_PWR_MGMT_1_TEMP_DIS_MSK) \
	| (ICM20948_REG_PWR_MGMT_1_CLKSEL_AUTO   \
	<< ICM20948_REG_PWR_MGMT_1_CLKSEL_POS))
...
#define ICM20948_REG_PWR_MGMT_2_DIS_GYRO       \
	(ICM20948_REG_PWR_MGMT_2_DISABLE_GYRO_MSK)
...
#define ICM20948_REG_INT_PIN_CFG_DEFAULT \
	(ICM20948_REG_INT_PIN_CFG_ACTL_MSK   \
	| ICM20948_REG_INT_PIN_CFG_OPEN_MSK)
...
#define ICM20948_REG_GYRO_CONFIG_1_DEFAULT            \
	((0x1 << ICM20948_REG_GYRO_CONFIG_1_FCHOICE_POS)  \
	| (ICM20948_REG_GYRO_CONFIG_1_FS_SEL_1000DPS       \
		<< ICM20948_REG_GYRO_CONFIG_1_FS_SEL_POS)     \
	| (0x2 << ICM20948_REG_GYRO_CONFIG_1_DLPFCFG_POS))

/* ICM20948_REG_GYRO_SMPLRT_DIV */
#define ICM20948_REG_GYRO_SMPLRT_DIV_DEFAULT      \
	((1125 + ICM20948_SAMPLE_RATE_DEFAULT -1) \
	/ ICM20948_SAMPLE_RATE_DEFAULT - 1)

/* REG_WRITE_ACCEL_INTEL_CTRL */
#define ICM20948_REG_ACCEL_INTEL_MODE_INT_POS (0)
#define ICM20948_REG_ACCEL_INTEL_EN_POS (1)
#define ICM20948_REG_ACCEL_INTEL_CTRL_EN          \
	((1 << ICM20948_REG_ACCEL_INTEL_MODE_INT_POS) \
	| (1 << ICM20948_REG_ACCEL_INTEL_EN_POS))
...
#define ICM20948_REG_ACCEL_CONFIG_DEFAULT            \
	((0x1 << ICM20948_REG_ACCEL_CONFIG_FCHOICE_POS)  \
	| (ICM20948_REG_ACCEL_CONFIG_FS_SEL_16G           \
		<< ICM20948_REG_ACCEL_CONFIG_FS_SEL_POS)     \
	| (0x2 << ICM20948_REG_ACCEL_CONFIG_DLPFCFG_POS))

/* ICM20948_REG_ACCEL_SMPLRT_DIV */
#define ICM20948_REG_ACCEL_SMPLRT_DIV_DEFAULT     \
	((1125 + ICM20948_SAMPLE_RATE_DEFAULT -1) \
	/ ICM20948_SAMPLE_RATE_DEFAULT - 1)
...
#define ICM20948_REG_I2C_MST_CTRL_DEFAULT                 \
	((1 << ICM20948_REG_I2C_MST_CTRL_I2C_MST_P_NSR_POS) | \
	(7 << ICM20948_REG_I2C_MST_CTRL_I2C_MST_CLK_POS))
...
#define ICM20948_REG_USER_CTRL_DEFAULT         \
	(1 << ICM20948_REG_USER_CTRL_I2C_MST_EN_POS) // (138) //  (10)

/* ICM20948_REG_I2C_SLV4_ADDR 8C */
#define ICM20948_REG_I2C_SLV4_ADDR_RNW_POS (7)
#define ICM20948_REG_I2C_SLV4_ADDR_ID_POS (0)
#define ICM20948_REG_I2C_SLV4_ADDR_WRITE_AK09916             \
	(AK09916_DEV_ADDR << ICM20948_REG_I2C_SLV4_ADDR_ID_POS)
#define ICM20948_REG_I2C_SLV4_ADDR_READ_AK09916              \
	((1 << ICM20948_REG_I2C_SLV4_ADDR_RNW_POS) |             \
	(AK09916_DEV_ADDR << ICM20948_REG_I2C_SLV4_ADDR_ID_POS))
...
#define ICM20948_REG_I2C_SLV4_CTRL_START              \
	(1 << ICM20948_REG_I2C_SLV4_CTRL_I2C_SLV4_EN_POS)

/* ICM20948_REG_I2C_MST_STATUS  40 */
#define ICM20948_REG_I2C_MST_STATUS_SLV4_DONE_POS (6)
#define ICM20948_REG_I2C_MST_STATUS_SLV4_DONE_MSK      \
	(0x1 << ICM20948_REG_I2C_MST_STATUS_SLV4_DONE_POS)

/* ICM20948_REG_I2C_SLV0_ADDR 8C */
#define ICM20948_REG_I2C_SLV0_ADDR_RNW_POS (7)
#define ICM20948_REG_I2C_SLV0_ADDR_ID_POS (0)
#define ICM20948_REG_I2C_SLV0_ADDR_WRITE_AK09916             \
	(AK09916_DEV_ADDR << ICM20948_REG_I2C_SLV0_ADDR_ID_POS)
#define ICM20948_REG_I2C_SLV0_ADDR_READ_AK09916              \
	((1 << ICM20948_REG_I2C_SLV0_ADDR_RNW_POS) |             \
	(AK09916_DEV_ADDR << ICM20948_REG_I2C_SLV0_ADDR_ID_POS))

/* ICM20948_REG_I2C_SLV0_CTRL 89 */
#define ICM20948_REG_I2C_SLV0_CTRL_EN_MSK (0x80)
#define ICM20948_REG_I2C_SLV0_CTRL_LENG_POS (0)
#define ICM20948_REG_I2C_SLV0_CTRL_START_LEN_9  \
	((ICM20948_REG_I2C_SLV0_CTRL_EN_MSK) |      \
	(9 << ICM20948_REG_I2C_SLV0_CTRL_LENG_POS))
...
static bool icm20948_setting_set(h_icm20948_t *p_h_icm,
...
//	static uint8_t reg_buff[1];
	static uint8_t reg_write[REG_WRITE_NUM] = {
		...
		[REG_WRITE_I2C_SLV4_ADDR_READ_AK09916]
		= ICM20948_REG_I2C_SLV4_ADDR_READ_AK09916,
		[REG_WRITE_I2C_SLV4_ADDR_WRITE_AK09916]
		= ICM20948_REG_I2C_SLV4_ADDR_WRITE_AK09916,
		...
		[REG_WRITE_I2C_SLV4_CTRL_START]
		= ICM20948_REG_I2C_SLV4_CTRL_START,
		[REG_WRITE_CNTL2] = AK09916_REG_CNTL2_DEFAULT,
		[REG_WRITE_I2C_SLV0_ADDR_READ_AK09916]
		= ICM20948_REG_I2C_SLV0_ADDR_READ_AK09916,
		[REG_WRITE_I2C_SLV0_REG_ST1] = AK09916_REG_ST1,
		[REG_WRITE_I2C_SLV0_CTRL_START_LEN_9]
		= ICM20948_REG_I2C_SLV0_CTRL_START_LEN_9, };
	static uint8_t reg_check[REG_CHECK_NUM] = {
		...
		[REG_CHECK_I2C_MST_STATUS_SLV4_DONE]
		= ICM20948_REG_I2C_MST_STATUS_SLV4_DONE_MSK,
		[REG_CHECK_WIA1] = AK09916_REG_WIA1_DEFAULT,
		[REG_CHECK_WIA2] = AK09916_REG_WIA2_DEFAULT,
		[REG_CHECK_INT_STATUS_1]
		= ICM20948_REG_INT_STATUS_1_ATA_0_RDY_INT_MSK, };
...
//			.p_reg_data = reg_buff,
	...
	const size_t h_reg_list_len = sizeof(h_reg_list)
			/ sizeof(h_icm20948_reg_list_t);
...
static bool icm20948_motion_det_set_process(h_icm20948_t *p_h_icm) {
	...
	static const uint8_t reg_write[REG_WRITE_NUM] = {
		[REG_WRITE_BANK_SEL_0] = ICM20948_REG_REG_BANK_SEL_0,
		[REG_WRITE_BANK_SEL_2] = ICM20948_REG_REG_BANK_SEL_2,
		[REG_WRITE_ACCEL_INTEL_EN] = ICM20948_REG_ACCEL_INTEL_CTRL_EN,
		[REG_WRITE_ACCEL_INTEL_DIS] = ICM20948_REG_ACCEL_INTEL_CTRL_DIS,
		[REG_WRITE_INT_ENABLE_WOM_EN] = ICM20948_REG_INT_ENABLE_WOM_EN,
		[REG_WRITE_INT_ENABLE_WOM_DIS] = ICM20948_REG_INT_ENABLE_WOM_DIS, };
	static const h_icm20948_reg_list_t h_reg_list_en[] = {
			...
			.delay = 5, },
		{
			...
			.reg_size = 1, }, };
	static const size_t h_reg_list_en_len = sizeof(h_reg_list_en)
			/ sizeof(h_icm20948_reg_list_t);
	static const h_icm20948_reg_list_t h_reg_list_dis[] = {
			...
			.delay = 5, },
		{
			...
			.reg_size = 1,
			.delay = 2, }, };
	static const size_t h_reg_list_dis_len = sizeof(h_reg_list_dis)
			/ sizeof(h_icm20948_reg_list_t);
...
bool icm20948_low_power_set_process(h_icm20948_t *p_h_icm) {
	...
	static const h_icm20948_reg_list_t h_reg_list_en[] = {
			...
			.delay = 2, },
		{
			...
			.reg_addr = ICM20948_REG_I2C_SLV4_ADDR,
			.p_reg_data =
					(void*) &reg_write[REG_WRITE_I2C_SLV4_ADDR_WRITE_AK09916],
			.reg_size = 1, },
		{
			.b_read_write = false,
			.reg_addr = ICM20948_REG_I2C_SLV4_REG,
...
//				p_h_i2c_sent->rx_size = p_h_list->reg_size;
			...
			case ICM20948_SENT_SPI: {
				...
				p_h_process->tx_buff[0] = p_h_list->reg_addr
						| ICM20948_SPI_REG_ADDR_READ_MSK;
...
////	static uint32_t time_log = 0;
	...
	case STEP_START:
		...
		case ICM20948_SENT_SPI: {
			h_icm20948_spi_t *p_h_spi_sent = &p_h_process->h_spi_sent;
			p_h_process->tx_buff[0] = reg_addr_begin
					| ICM20948_SPI_REG_ADDR_READ_MSK;
			p_h_spi_sent->p_tx_buff = p_h_process->tx_buff;
			p_h_spi_sent->p_rx_buff = p_h_process->rx_buff;
