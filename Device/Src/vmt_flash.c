...
flash_res_t flash_erase_sector(uint32_t sector) {
	...
	__HAL_FLASH_CLEAR_FLAG(
			FLASH_FLAG_EOP | FLASH_FLAG_OPERR | FLASH_FLAG_WRPERR | FLASH_FLAG_PGAERR | FLASH_FLAG_PGPERR | FLASH_FLAG_ERSERR);
...
__weak void flash_cplt_callback(FLASH_ProcedureTypeDef proc,
		uint32_t ReturnValue) {
}
__weak void flash_ops_error_callback(FLASH_ProcedureTypeDef proc,
		uint32_t ReturnValue) {
}
